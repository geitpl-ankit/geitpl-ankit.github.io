  ...
  * ========================= */
  ...
  , toggle: function (e) {
      ...
      if (!isActive) {
        ...
        $parent.find('.option > li > [data-option="' + $this.find('.bfh-selectbox-option').data('option') + '"]').focus()
      }
  ...
  , keydown: function (e) {
      ...
      $items = $('.option li a', $parent).filter(':visible')

      if (!$items.length) return

      $('body').off('mouseenter.bfh-selectbox.data-api', '.option > li > a', BFHSelectBox.prototype.mouseenter)
      ...
      $('body').on('mouseenter.bfh-selectbox.data-api', '.option > li > a', BFHSelectBox.prototype.mouseenter)
    }
  ...
  $(function () {
    ...
    $('body')
      ...
      .on('keydown.bfhselectbox.data-api', toggle + ', .option' , BFHSelectBox.prototype.keydown)
      .on('mouseenter.bfhselectbox.data-api', '.option > li > a', BFHSelectBox.prototype.mouseenter)
      .on('click.bfhselectbox.data-api', '.option > li > a', BFHSelectBox.prototype.select)  
